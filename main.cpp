...
// Hardware Stuff
#include <OneWire.h> //needed for DallasTemperature.h library
#include <DallasTemperature.h> //library for DS18b20 sensor

#define ONE_WIRE_BUS 2 //DS Sensor connect to pin 2

OneWire oneWire(ONE_WIRE_BUS);

DallasTemperature sensors(&oneWire);
DeviceAddress Internal, External; // array for storing addresses
...
//function for reading the coffee level sensor
int CheckLevel(void)
{
    int l = 0;
    ...
    //turn off pull up resistors because weird things were happening when I didn't
